...
* ### Part 4
   * Data Structures:
      * Arrays and strings
      * Hashing(https://www.cs.cornell.edu/courses/cs2110/2017sp/recitations/recitation07/HashPresentationSummary.pdf)
      * Lists
      * Stacks and queues
      * Priority queues
      * Trees and graphs
   ...
   * Network flow: Ford-Fulkerson algorithm, flows and cuts, image segmentation, the bipartite matching problem.
